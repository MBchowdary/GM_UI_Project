...
public class TopTagsRepository {
    ...
    public LiveData<List<TagItem>> getTopTagsList() {
        ...
        //mTopTagsApi.getTopTags("tag.getTopTags",Utils.API_KEY,Utils.FORMAT).enqueue(new Callback<TopTagsResponse>() {
        final Call<TopTagsResponse> call = mTopTagsApi.getTopTags();
